...
lar --process-name citest-reco3D -c standard_reco_uboone_3D.fcl -s ../lar_ci_openold_detsim2d_uboonecode/openclose_reco2D_uboone.root -n 1 -o openclose_reco3D_uboone.root -T openclose_reco3D_hist_uboone.root

...
lar --process-name citest-reco2D -c standard_reco_uboone_2D.fcl -s ../lar_ci_openold_detsim_uboonecode/openclose_detsim_uboone.root -n 1 -o openclose_reco2D_uboone.root -T openclose_reco2D_hist_uboone.root

...
echo "outputs.out1.fileName: 'hitana_uboone_prod.root'" >> ./prod_muminus_0.1-2.0GeV_isotropic_uboone.fcl
lar -c ./prod_muminus_0.1-2.0GeV_isotropic_uboone.fcl -n 60 -T hitana_uboone_prod_hist.root -o hitana_uboone_prod.root

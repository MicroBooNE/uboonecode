 ...
 */
using MicroBooNEGeometryTestFixture
...
// BOOST_FIXTURE_TEST_SUITE(GeometryIterators, MicroBooNEGeometryTestFixture)
BOOST_GLOBAL_FIXTURE(MicroBooNEGeometryTestFixture)
...
BOOST_AUTO_TEST_CASE( CryostatIteratorsTest )
{
  ...
  geo::GeometryCore const* geom
    = MicroBooNEGeometryTestFixture::GlobalGeometry();

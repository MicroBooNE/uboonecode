/**
 * @file   geometry_uboone_test.cxx
 * @brief  Unit test for geometry on MicroBooNE detector
 * @date   May 11th, 2015
 * @author petrillo@fnal.gov
 * 
 * Usage:
 *   `geometry_uboone_test  [ConfigurationFile [GeometryTestParameterSet]]`
 * 
...
int main(int argc, char const** argv) {
  ...
  MicroBooNEGeometryConfiguration config("geometry_test_MicroBooNE");
  ...
  if (nErrors > 0) {
    mf::LogError("geometry_test_MicroBooNE") << nErrors << " errors detected!";
  }
